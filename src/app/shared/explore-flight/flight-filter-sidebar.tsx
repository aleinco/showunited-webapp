import FilterWithSearch from '@/components/core/filter-with-search';
import FilterWithAccordion from '@/components/core/filter-with-accordion';
import FilterWithGroup from '@/components/core/filter-with-group';
import {
  airlinesData,
  bookingData,
  layoverAirportsData,
