...
import { getRatings } from '@/components/core/table-utils/get-ratings';
import { getStatusBadge } from '@/components/core/table-utils/get-status-badge';
import { getStockStatus } from '@/components/core/table-utils/get-stock-status';
import { routes } from '@/config/routes';
import { ProductType } from '@/data/products-data';
import EyeIcon from '@/components/core/icons/eye';
import PencilIcon from '@/components/core/icons/pencil';
