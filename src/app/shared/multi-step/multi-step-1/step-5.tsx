...
import UserFamilyColorIcon from '@/components/core/icons/user-family-color';
import QuantityInput from '@/app/shared/multi-step/quantity-input';
import UsersColorIcon from '@/components/core/icons/users-color';
import UserColorIcon from '@/components/core/icons/user-color';
import {
  FormStep5Schema,
  formStep5Schema,
