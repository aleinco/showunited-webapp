...
import WidgetCard from '@/components/core/cards/widget-card';
import DropdownAction from '@/components/core/charts/dropdown-action';
import ContainersIcon from '@/components/core/icons/containers';
import ExpenseIcon from '@/components/core/icons/expenses';
import ExpressDeliveryIcon from '@/components/core/icons/express-delivery';
import RevenueUpIcon from '@/components/core/icons/revenue-up';
import SalesIcon from '@/components/core/icons/sales';
import TrendingDownIcon from '@/components/core/icons/trending-down';
import TrendingUpIcon from '@/components/core/icons/trending-up';
