...
const TABS = [
  { key: 'listings', label: 'All Jobs', icon: PiListBulletsLight },
  ...
  return (
    <div>
      ...
      <div className="mb-4 pt-4 md:pt-6">
        <h1 className="text-2xl font-bold text-gray-900 px-4 md:px-0">Jobs</h1>
        <p className="mt-1 text-[14px] text-gray-500 px-4 md:px-0">
          Find your next opportunity in the entertainment industry
        </p>
      </div>
                ...
                <div className="flex flex-col gap-4">
                  {items.map((item) => (
                    <JobCard
                      ...
                      recordType={item.RecordType || 'Job'}
                      title={item.Title}
