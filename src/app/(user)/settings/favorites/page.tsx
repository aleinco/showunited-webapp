...
import { PiCaretLeftBold, PiStarLight } from 'react-icons/pi';
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="flex items-center border-b border-gray-100 px-4 py-3 md:hidden">
        ...
        <h1 className="flex-1 text-center text-lg font-semibold text-gray-900">Favorites</h1>
        <div className="w-8" />
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20">
        <PiStarLight className="mb-3 h-16 w-16 text-gray-300" />
